              ...
              <TableBody>
                <TableRow>
                  <TableCell className='fee-cell' align="left" sx={{fontWeight: 'bold'}}>National Diabetes Services Scheme (NDSS)
                    <Typography variant='body2' sx={cellText}> 
                      NDSS is a government led initiative that provides information and support services to people with diabetes.
                    </Typography>
                  </TableCell>
                ...
                <TableRow>
                  <TableCell className='fee-cell' align="left" sx={{fontWeight: 'bold'}}>National Relay Service (NRS)
                    <Typography sx={cellText} variant='body2'> 
                      NRS assists individuals who are deaf or have difficulty speaking or hearing make phone call.
                    </Typography>
                ...
                <TableRow>
                  <TableCell className='fee-cell' align="left" sx={{fontWeight: 'bold'}}>Translating and Interpreting Service (TIS National)
                    <Typography variant='body2' sx={cellText}>
                      TIS National is a interpreting service for non-English or limited English speakers.
                    </Typography>
                  </TableCell>
                  <TableCell className='fee-cell' align="left">
                ...
                <TableRow>
                  <TableCell className='fee-cell' align="left" sx={{fontWeight: 'bold'}}>Sydney Medical Service Co-op (Sydmed)
                    <Typography variant='body2' sx={cellText}>
                      Sydmed is a non-profit co-op that provides after hours bulk-billed home visits/appointments.
                    </Typography>
                  </TableCell>
                  <TableCell className='fee-cell' align="left">
