    ...
    <Box sx={{ display: 'flex', alignItems: 'center', flexDirection: 'column', width: 'calc(100% - 100px)', margin: '100px 0px 50px', position: 'relative', left: '50px' }}> 
      ...
      <Box sx={{ display: 'flex', gap: '50px', flexWrap: 'wrap'}}>
        <Paper sx={{padding: '30px',  display: 'flex', alignItems: 'stretch', flexDirection: 'column', }}>
          ...
          <Typography>We abide by the 10 Nation Privacy Principles avaliable at: <span><Link>www.privacy.gov.au/health/index.html</Link></span></Typography>
          

        </Paper>
      <Box sx={{display: 'flex', flexDirection: 'row', gap: '50px', justifyContent: 'space-between', flexWrap: 'wrap'}}>
        <Box sx={{ display: 'flex', alignItems: 'stretch', gap: '30px', justifyContent: 'space-between', flexDirection: 'column', flexGrow: 1, width: '50%' }}>
          <Paper sx={{padding: '30px 40px'}}>
            ...
            <Typography variant='body1' sx={{marginBottom: '20px'}}> Our practice is commited to preventative care. Your doctor will seek your permission to be included on our reminder system. We may issue you with a reminder notice from time to time, offering you preventative health services appropriate to your care.</Typography>
            <Typography variant='body1' sx={{fontWeight: 'bold'}}>If you do not wish to be part of this system, please let your doctor or the reception staff know.</Typography>
          </Paper>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'row', gap: '30px', justifyContent: 'space-between', flexWrap: 'wrap', flexGrow: 1}}>
        <Paper sx={{display: 'flex', flexDirection: 'column', padding: '20px', flexGrow: 1}}>
            <Stack direction='row' gap='10px'>
