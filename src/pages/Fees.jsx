        ...
        <Box sx={{ display: 'flex', alignItems: 'stretch', gap: '30px', justifyContent: 'space-between', flexDirection: 'column', width: '50%', flexGrow: 2}}>
            ...
            <Box sx={{maxHeight: '1100px', overflowY: 'auto', overflowX: 'auto', width: 'inherit'}}>
              <Table stickyHeader dense='true' sx={{tableLayout: 'fixed', width: '100%',}} >
                <TableHead >
                  <TableRow >
                    <TableCell className='fee-cell' align="left" sx={{fontWeight: 'bold' , backgroundColor: '#11225A', color: 'white' }}>Item</TableCell>
                    <TableCell className='fee-cell' align="left" sx={{...cell, fontWeight: 'bold', backgroundColor: '#11225A', color: 'white'}}>Description</TableCell>
                    <TableCell className='fee-cell' align="left" sx={{fontWeight: 'bold', backgroundColor: '#11225A', color: 'white'}}>Fee</TableCell>
                    <TableCell className='fee-cell' align="left" sx={{fontWeight: 'bold', backgroundColor: '#11225A', color: 'white'}}>Medicare Rebate</TableCell>
                    <TableCell className='fee-cell' align="left" sx={{fontWeight: 'bold', backgroundColor: '#11225A', color: 'white'}}>Out of Pocket Cost</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  <TableRow>
