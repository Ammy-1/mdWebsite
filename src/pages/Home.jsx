...
import accredImg from '../assets/AGPAL Accredited Symbol_PNG.png'
  ...
  return (
    <>
      <Box sx={{
        ...
        flexGrow: '1', 
        flexWrap: 'wrap', 
        ['@media (max-width: 400px)']: {backgroundPositionX: '32%'}
      }}> 
        <Box 
          sx={{ 
            display: 'flex',
            ...
            ['@media (max-width: 400px)']: {alignContent: 'center', gap: '10px'},
            ['@media (max-width: 600px)']: {flexWrap: 'wrap'}, 
            backdropFilter: 'saturate(60%)'
          }}> 
          <Box 
            sx={{
              width: '50%',
              ...
              alignItems: 'flex-end', 
              ['@media (max-width: 800px)']: {alignItems: 'flex-start'}, 
              ['@media (max-width: 400px)']: {width: '100%', height: '100px'}
            }}>
            <Typography 
              variant='h3' 
              sx={{['@media (max-width: 900px)']: {fontSize: '1.5rem'}}}>
                Welcome to
            </Typography>
            <Typography 
              variant='h2' 
              sx={{['@media (max-width: 900px)']: {fontSize: '2.5rem'}}}>
              MDplus Clinic
            </Typography>
          </Box>
      ...
      > 
        <Typography 
        variant='h6' 
        sx={{color: '#11225A', fontWeight: 'bold'}}
        >
      ...
      >
        ...
        >
            ...
            >
              ...
              >
                <List 
                  sx={{ listStyleType: 'disc', color: 'black'}} 
                  dense={true}
                >
                ...
                <List 
                  sx={{ 
                    listStyleType: 'disc',
                     color: 'black',
                    ['@media (max-width: 560px)']: {position: 'relative', right: '23px', bottom: '15px'}}} 
                    dense={true}
                  >
        ...
        <Paper 
          ...
          sx={{
            ...
            width: '20%', 
            minWidth: '225px', 
            ['@media (max-width: 400px)']: {minWidth: '180px'}
          }}
        >
          <Typography 
            variant='h4' 
            sx={{color: '#000', paddingBottom: '20px'}}
          >
            Opening Hours
          </Typography>
          <OpeningHrs/>
